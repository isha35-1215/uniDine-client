        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 mx-auto gap-10 my-10 px-12 md:px-20 lg:px-24">
                ...
                {membership.map((member) => (
                    <div key={member.id} className="card card-compact h-[320px] bg-base-100 shadow-xl border-orange-500 border-[1px]">
                        ...
                        <div className="card-body text-center">
                            ...
                            <div className="card-actions flex flex-row justify-center">
                                <Link to={`/checkout/${member.name}`} >
                                    <button className="btn btn-warning w-56 text-base text-white bg-orange-500 border-orange-400 normal-case">Checkout</button>
                                </Link>
                            </div>
                        </div>
                    </div>
